...
namespace ISONET.Domain.Entities.DataElements
{
    ...
    {
        //Custom  Data Element
        public DE013(IAtrribute attribute, IConditionUse conditionUse, string description, string name, object value)
        {
            Attribute = attribute;
            Bit = 013;
        ...
        //Custom  Data Element
        public DE013(IAtrribute attribute, IConditionUse conditionUse, string description, string name)
        {
            Attribute = attribute;
            Bit = 013;
            ConditionUse = conditionUse;
