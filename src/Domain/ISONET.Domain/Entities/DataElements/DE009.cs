...
namespace ISONET.Domain.Entities.DataElements
{
    ...
    {
        //Custom  Data Element
        public DE009(IAtrribute attribute, IConditionUse conditionUse, string description, string name, object value)
        {
            Attribute = attribute;
            Bit = 009;
        ...
        //Custom  Data Element
        public DE009(IAtrribute attribute, IConditionUse conditionUse, string description, string name)
        {
            Attribute = attribute;
            Bit = 009;
            ConditionUse = conditionUse;
