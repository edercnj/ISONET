...
namespace ISONET.Domain.Entities.DataElements
{
    ...
    {
        //Custom Data Element
        public DE080(IAtrribute attribute, IConditionUse conditionUse, string description, string name, object value)
        {
            Attribute = attribute;
            Bit = 080;
        ...
        //Custom Data Element
        public DE080(IAtrribute attribute, IConditionUse conditionUse, string description, string name)
        {
            Attribute = attribute;
            Bit = 080;
            ConditionUse = conditionUse;
