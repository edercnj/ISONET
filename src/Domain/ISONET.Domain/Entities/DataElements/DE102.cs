...
namespace ISONET.Domain.Entities.DataElements
{
    ...
    {
        //Custom Data Element
        public DE102(IAtrribute attribute, IConditionUse conditionUse, string description, string name, object value)
        {
            Attribute = attribute;
            Bit = 102;
        ...
        //Custom Data Element
        public DE102(IAtrribute attribute, IConditionUse conditionUse, string description, string name)
        {
            Attribute = attribute;
            Bit = 102;
            ConditionUse = conditionUse;
